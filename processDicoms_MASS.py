...
try:
	for line in file_ids:
		...
		SELECT     Patient.Patients.MRN, Patient.Patients.StudyNumber, Radiology.RadiologyReport.DicomExamNumber, Radiology.RadiologyReport.DateOfExam, 
                      ...
                      Lesion.DCEInitialEnhPhaseType.Description AS Expr3, Radiology.MassLesion.LesionFindingID, Lesion.MassLesionIntEnhanceType.MassIntEnhanceTypeID, 
		...
		while(choseSerie!='x'):
			...
			if len(row) != 0:
				...
				print "%s" % str("DCEDelayEnhPhaseType: ")+str( row[17])+'\n'+str("DCEInitialEnhPhaseType.Desc ")+str( row[18])+'\n'+str("MassIntEnhanceTypeID: ")+str( row[20])
				print "%s" % str("MassLesionIntEnhanceType.Desc: ")+str( row[21])+'\n'+str("MassShapeTypeID.Desc: ")+str( row[22])+'\n'+str("MassLesionShapeType.Desc: ")+str( row[23])+'\n'+str("MassMarginTypeID: ")+str( row[24])+'\n'+str("MassLesionMarginType.Desc: ")+str( row[25])+'\n'
			...
			if len(row) != 0:
				...
				file_summary_cases.write(str("DCEDelayEnhPhaseType: ")+str( row[17])+'\n'+str("DCEInitialEnhPhaseType.Desc ")+str( row[18])+'\n'+str("MassIntEnhanceTypeID: ")+str( row[20]))
				file_summary_cases.write(str("MassLesionIntEnhanceType.Desc: ")+str( row[21])+'\n'+str("MassShapeTypeID.Desc: ")+str( row[22])+'\n'+str("MassLesionShapeType.Desc: ")+str( row[23])+'\n'+str("MassMarginTypeID: ")+str( row[24])+'\n'+str("MassLesionMarginType.Desc: ")+str( row[25])+'\n')
